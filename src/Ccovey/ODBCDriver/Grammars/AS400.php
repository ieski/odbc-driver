...
class AS400 extends Grammar
{
    ...
    protected function compileAnsiOffset(\Illuminate\Database\Query\Builder $query, $components)
    {
        ...
        //FIX: from d�zeltildi.
        if ($columns == 'select *, ' )  $columns = substr($components['from'], 5) .'.*';
    ...
    {
        //FIX: i� i�e sorgu select from yoktu
        return "select {$columns}, Row_Number() Over ({$orderings}) as row_num";
    }
